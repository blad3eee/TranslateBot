...
class AutoSetText:
    @staticmethod
    async def autosettext(message: types.Message, state: FSMContext):
        if message.text == 'Назад в меню':
            ...
            async with state.proxy() as data:
                ...
                params = {'engine': 'google', 'to': endLanguagesDict[data['end'].lower()], 'text': data['text']}
    ...
    @staticmethod
    def autotext_handler(dp: Dispatcher):
        dp.register_message_handler(AutoSetText.autosettext, state=AutoMessageGet.message)